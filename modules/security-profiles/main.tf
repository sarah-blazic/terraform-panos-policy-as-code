...
resource "panos_antivirus_security_profile" "this" {
  for_each = var.antivirus != "optional" ? { for virus in var.antivirus : virus.name => virus } : tomap({})
...
resource "panos_anti_spyware_security_profile" "this" {
  for_each = var.spyware != "optional" ? { for file in var.spyware : file.name => file } : tomap({})
...
resource "panos_vulnerability_security_profile" "this" {
  for_each = var.vulnerability != "optional" ? { for file in var.vulnerability : file.name => file } : tomap({})
